...
const icon = require('../assets/facebook-signin-icon.png');
...
/**
 * FacebookSignInButton component properties
 *
 ...
 *
 */
const FacebookSignInButton: React.FC<FacebookSignInButtonProps> = (props) => {
  ...
  return (
    <Pressable onPress={props.onPress} testID="facebook-signin-button">
